...
public class SimpleExoPlayer implements ExoPlayer {
  ...
  // Make sure this is called after prepare(), otherwise this has no effect
  public void resolveBitrateCap() {
    //we move this function to EPLPlayerContainer2,please see EPLPlayerContainer2.resolveBitrateCap
    //why keep this method here as we don't want break the previous caller done by accedo
    //add by jf
  }
