...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener<Object> {
  // Current bandwidth is capable to play the highest quality format
  public final static int BANDWIDTH_LEVEL_HIGH = 0;
  // Current bandwidth capability is between the highest and the lowest
  public final static int BANDWIDTH_LEVEL_MEDIUM = 1;
  // Current bandwidth is only capable to play the lowest quality
  public final static int BANDWIDTH_LEVEL_LOW = 2;
  /**
  ...
  private BandwidthHealthListener bandwidthHealthListener;

  public void setBandwidthHealthListener(BandwidthHealthListener listener) {
    this.bandwidthHealthListener = listener;
  }

  public BandwidthHealthListener getBandwidthHealthListener() {
    return bandwidthHealthListener;
  }

  public interface BandwidthHealthListener {
    void onBandwidthHealthUpdate(int healthLevel);
  }
}
