...
public abstract class MediaCodecTrackRenderer extends SampleSourceTrackRenderer {
  ...
  private boolean disableSecureCodec = false;
  ...
  private static boolean codecNeedsFlushWorkaround(String name) {
    return Util.SDK_INT < 18
            ...
            || (Util.MODEL.startsWith("SM")
            && ("OMX.Exynos.avc.dec".equals(name) || "OMX.Exynos.avc.dec.secure".equals(name) || "OMX.qcom.video.decoder.avc.secure".equals(name) || "OMX.qcom.video.decoder.avc".equals(name)));
  }
  ...
  public void setDisableSecureCodec(boolean disable) {
    this.disableSecureCodec = disable;
  }
